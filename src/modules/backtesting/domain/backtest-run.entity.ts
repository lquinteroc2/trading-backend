...
export class BacktestRunEntity {
  constructor(
    ...
    public readonly signalsBeforeFilters: number,
    public readonly signalsAfterFilters: number,
    public readonly filteredSignals: number,
    public readonly filterReasons: unknown,
